...
$TESTSRC/../../bin/javac -cp $TESTSRC/../../dist/checker.jar -doe -d $TESTCLASSES -processor org.checkerframework.checker.gradualnullness.GradualNullnessChecker $TESTSRC/InterfaceTest.java $TESTSRC/IInterface.java
